...
public sealed class LoginPage : BasePage
{
    ...
    //Returns the user visible text from the data-test error element for invalid login:
    [FindsBy(How = How.CssSelector, Using = "[data-test='error']")] private IWebElement? InvalidUserDetailsError { get; set; }
    ...
    public string GetErrorMessage() => InvalidUserDetailsError!.Text;
}
