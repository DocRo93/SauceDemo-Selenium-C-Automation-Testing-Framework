...
public static class ExtentReportManager
{
    ...
    public static void Initialise(string reportType, string directory)
    {
        ...
        lock (Sync)
        {
            ...
            string absoluteReportPath = Path.Combine(absoluteDirectory, $"ExtentReport_{DateTime.Now:yyyyMMdd_HHmmss}.html");

            var reporter = new ExtentSparkReporter(absoluteReportPath);
